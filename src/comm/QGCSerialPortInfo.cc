...
static const struct VIDPIDMapInfo_s {
    ...
    { QGCSerialPortInfo::px4VendorId,           QGCSerialPortInfo::Sparky2ProductId,                    QGCSerialPortInfo::BoardTypeSparky2,    "Found Sparky2" },
...
QGCSerialPortInfo::BoardType_t QGCSerialPortInfo::boardType(void) const
{
    ...
    if (boardType == BoardTypeUnknown) {
        ...
        } else if (description() == "PX4 Sparky2" || description() == "PX4 BL Sparky2") {
            qCDebug(QGCSerialPortInfoLog) << "Found Sparky2 (by name matching fallback)";
            boardType = BoardTypeSparky2;
...
bool QGCSerialPortInfo::boardTypePixhawk(void) const
{
    ...
    return boardType == BoardTypePX4FMUV1 || boardType == BoardTypePX4FMUV2
            ...
            || boardType == BoardTypeASCV1 ||  boardType == BoardTypeSparky2;
}
